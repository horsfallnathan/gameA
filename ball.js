class Ball {
    ...
    draw() {
        ...
        game.player.aPlayer.bounce(this.ballSpr, afterCollision());
...
function afterCollision() {
    // game.ball.ballSpr.velocity.x += 0.03;
    // game.ball.ballSpr.velocity.y += 0.03;
    // game.ball.ballSpr.velocity.z += 180;
    if (keyWentDown('s')) {
